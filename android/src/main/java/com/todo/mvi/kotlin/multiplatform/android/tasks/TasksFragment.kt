...
import com.todo.mvi.kotlin.multiplatform.android.addedittask.AddEditTaskActivity
...
import com.todo.mvi.kotlin.multiplatform.android.taskdetail.TaskDetailActivity
import com.todo.mvi.kotlin.multiplatform.android.tasks.TasksFilterType.ACTIVE_TASKS
import com.todo.mvi.kotlin.multiplatform.android.tasks.TasksFilterType.ALL_TASKS
import com.todo.mvi.kotlin.multiplatform.android.tasks.TasksFilterType.COMPLETED_TASKS
import com.todo.mvi.kotlin.multiplatform.android.tasks.TasksIntent.ActivateTaskIntent
import com.todo.mvi.kotlin.multiplatform.android.tasks.TasksIntent.CompleteTaskIntent
import com.todo.mvi.kotlin.multiplatform.android.tasks.TasksViewState.UiNotification.COMPLETE_TASKS_CLEARED
import com.todo.mvi.kotlin.multiplatform.android.tasks.TasksViewState.UiNotification.TASK_ACTIVATED
...
class TasksFragment : Fragment(), MviView<TasksIntent, TasksViewState> {
  ...
  private fun bind() {
    ...
    disposables.add(
        listAdapter.taskClickObservable.subscribe { task -> showTaskDetailsUi(task.id.toString()) })
  }
