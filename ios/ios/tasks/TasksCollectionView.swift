                            ...
                            MDCRippleTouchControllerDelegate
{
    ...
    public let taskClickSubject = RxSwift.PublishSubject<Task>()
    public let taskToggleSubject = RxSwift.PublishSubject<Task>()
    lazy var disposables: RxSwift.CompositeDisposable = CompositeDisposable()
    
    var taskClickObservable: RxSwift.Observable<Task> {
        return taskClickSubject
    }
    
    var taskToggleObservable: RxSwift.Observable<Task> {
